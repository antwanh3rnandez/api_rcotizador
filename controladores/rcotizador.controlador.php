...
class ControladorCotizador
{
    public static function ctrRecibirDatos($json)
    {
        ...
        if ($tipoHsbc == "Creciente") {
            $pagoXMilHsbc = Payments::annuity(($tasaSantander / 100) / 12, $data['montos']['plazo'], -1000);
        } else {
        ...
        if ($errBanorte) {
            ...
            $banorte = array(
                "tasaBanorte" => $tasaBanorte,
                "pagoXMilBanorte" => $pagoXMilBanorte,
                "sueldoReqBanorte" => $sueldoReqBanorte,
                "factorSVBanorte" => $factorSVBanorte,
                "factorSDBanorte" => $factorSDBanorte,
                "comisionBanorte" => $comisionBanorte,
                "sueldoConComisionBanorte" => $sueldoConComisionBanorte,
                "seguroVidaBanorte" => $seguroVidaBanorte,
                "seguroDaniosBanorte" => $seguroDaniosBanorte,
                "creditoBanorteBanorte" => $creditoBanorte,
                "montoCreditoBanorte" => $montoCreditoBanorte,
                "valorViviendaBanorte" => $valorViviendaBanorte,
                "valorDestructibleBanorte" => $valorDestructibleBanorte,
                "pagoTotalSinGastosInicialesBanorte" => $jsBanorte->banorte->montos->pagoTotalMensualidades,
                "mensualidaPromedioBanorte" => $mensualidadPromedioBanorte,
                "aforoBanorte" => $jsBanorte->banorte->montos->aforo,
                "sueldoParaGastosBanorte" => $sueldoParaGastosBanorte
            );
            ...
            $scotiabank = array(
                "tasaScotiabank" => $tasaScotiabank,
                "pagoXMilScotiabank" => $pagoXMilScotiabank,
                "factorSueldoScotiabank" => $factorSueldoScotiabank,
                "seguroVidaScotiabank" => $seguroVidaScotiabank,
                "seguroDaniosScotiabank" => $seguroDaniosScotiabank,
                "sueldoReqScotiabank" => $sueldoReqScotiabank,
                "montoCreditoScotiabank" => $montoCreditoScotiabank,
                "valorViviendaScotiabank" => $valorViviendaScotiabank,
                "montoCreditoScotiabank" => $montoCreditoScotiabank,
                "valorViviendaScotiabank" => $valorViviendaScotiabank,
                "pagoTotalSinGastosInicialesScotiabank" => $jsScotiabank->scotiabank->montos->pagoTotalMensualidades,
                "mensualidaPromedioScotiabank" => $mensualidadPromedioScotiabank,
                "aforoScotiabank" => $jsScotiabank->scotiabank->montos->aforo * 100,
                "sueldoParaGastosScotiabank" => $sueldoParaGastosScotiabank
            );
            ...
            $hsbc = array(
                "tasaHsbc" => $tasaHsbc,
                "pagoXMilHsbc" => $pagoXMilHsbc,
                "factorSueldoHsbc" => $factorSueldoHsbc,
                "sueldoConComisionHsbc" => $sueldoConComisionHsbc,
                "seguroVidaHsbc" => $seguroVidaHsbc,
                "seguroDaniosHsbc" => $seguroDaniosHsbc,
                "sueldoReqHsbc" => $sueldoReqHsbc,
                "montoCreditoHsbc" => $montoCreditoHsbc,
                "valorViviendaHsbc" => $valorViviendaHsbc,
                "pagoTotalSinGastosInicialesHsbc" => $jsHsbc->hsbc->montos->pagoTotalMensualidades,
                "mensualidaPromedioHsbc" => $mensualidadPromedioHsbc,
                "aforoHsbc" => $jsHsbc->hsbc->montos->aforo * 100,
                "sueldoParaGastosHsbc" => $sueldoParaGastosHsbc
            );
            ...
            $santander = array(
                "tasaSantander" => $tasaSantander,
                "pagoXMilSantander" => $pagoXMilSantander,
                "seguroVidaSantander" => $seguroVidaSantander,
                "seguroDaniosSantander" => $seguroDaniosSantander,
                "sueldoReqSantander" => $sueldoReqSantander,
                "montoCreditoSantander" => $montoCreditoSantander,
                "valorViviendaSantander" => $valorViviendaSantander,
                "valorDestructibleSantander" => $valorDestructibleSantander,
                "pagoTotalSinGastosInicialesSantander" => $jsSantander->santander->montos->pagoTotalMensualidades,
                "mensualidaPromedioSantander" => $mensualidadPromedioSantander,
                "aforoSantander" => $jsSantander->santander->montos->aforo * 100,
                "sueldoParaGastosSantander" => $sueldoParaGastosSantander
            );
            ...
            $citibanamex = array(
                "tasaCitibanamex" => $tasaCitibanamex,
                "pagoXMilCitibanamex" => $pagoXMilCitibanamex,
                "sueldoReqCitibanamex" => $sueldoReqCitibanamex,
                "montoCreditoCitibanamex" => $montoCreditoCitibanamex,
                "valorViviendaCitibanamex" => $valorViviendaCitibanamex,
                // "pagoTotalSinGastosInicialesCitibanamex" => $jsCitibanamex->citi->montos->pagoTotalMensualidades,
                // "mensualidaPromedioCitibanamex" => $mensualidadPromedioCitibanamex,
                // "aforoCitibanamex" => $jsCitibanamex->citi->montos->aforo,
                // "sueldoParaGastosCitibanamex" => $sueldoParaGastosCitibanamex
            );
            ...
            $heyBanco = array(
                "tasaHeyBanco" => $tasaHeybanco,
                "pagoXMilHeybanco" => $pagoXMilHeybanco,
                "sueldoReqHeyBanco" => $sueldoReqHeyBanco,
                "sueldoConComisionHeyBanco" => $sueldoConComisionHeyBanco,
                "segurosHeyBanco" => $segurosHeyBanco,
                "sueldoMenosSeguroHeyBanco" => $sueldoMenosSeguroHeyBanco,
                "sueldoMenosFactorHeyBanco" => $sueldoMenosFactorHeyBanco,
                "seguroVidaHeyBanco" => $seguroVidaHeyBanco,
                "seguroITPHeyBanco" => $seguroITPHeyBanco,
                "seguroDesempleoHeyBanco" => $seguroDesempleoHeyBanco,
                "baseCreditoHeyBanco" => $baseCreditoHeyBanco,
                "montoCreditoHeyBanco" => $montoCreditoHeyBanco,
                "valorViviendaHeyBanco" => $valorViviendaHeyBanco,
                "pagoTotalSinGastosInicialesHeyBanco" => $jsHeyBanco->hey->montos->pagoTotalMensualidades,
                "mensualidaPromedioHeyBanco" => $mensualidadPromedioHeyBanco,
                "aforoHeyBanco" => $jsHeyBanco->hey->montos->aforo,
                "sueldoParaGastosHeyBanco" => $sueldoParaGastosHeyBanco
            );
            ...
            $afirme = array(
                "tasaAfirme" => $tasaAfirme,
                "pagoXMilAfirme" => $pagoXMilAfirme,
                "sueldoReqAfirme" => $sueldoReqAfirme,
                "seguroVidaAfirme" => $seguroVidaAfirme,
                "seguroDaniosAfirme" => $seguroDaniosAfirme,
                "seguroInternoAfirme" => $seguroInternoAfirme,
                "montoCreditoAfirme" => $montoCreditoAfirme,
                "valorViviendaAfirme" => $valorViviendaAfirme,
                "pagoTotalSinGastosInicialesAfirme" => $jsAfirme->afirme->montos->pagoTotalMensualidades,
                "mensualidaPromedioAfirme" => $mensualidadPromedioAfirme,
                "aforoAfirme" => $jsAfirme->afirme->montos->aforo,
                "sueldoParaGastosAfirme" => $sueldoParaGastosAfirme
            );
